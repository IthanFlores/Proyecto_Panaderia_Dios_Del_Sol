...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/panes.css?v=1.1">
</head>
...
<body>
    ...
    <aside class="sidebar-menu">
        ...
        <nav class="btns-inventario">
            <button class="btns-inventario__boton btns-inventario__boton-agregar"
                onclick="location.href='tb_panes/agregar.php'">Agregar Pan</button>
            <button class="btns-inventario__boton btns-inventario__boton-buscar"
                onclick="location.href='tb_panes/buscar.php'">Buscar pan</button>
            <button class="btns-inventario__boton btns-inventario__boton-encargados"
                onclick="location.href='../../encargados.html'">Ver Panaderos</button>
    ...
    <main class="pantalla-principal">
        ...
        <h1 class="title_table" style="text-align: center !important; width: 100%; display: block;">Gestión de Panes
        </h1>
